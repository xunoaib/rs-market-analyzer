...
ORDER BY (extract(epoch from now()) - latest."highTime") ASC --Ordered by data staleness instead of max profit. I suspect an API call every 5 minutes might not be enough
